...
// Re-exported so the panels keep their single charts.tsx import surface; the hook itself lives in
// its own recharts-free module so MapView can use it without pulling recharts (~112 KB gzipped)
// into Map mode through this file.
export { useInsightTheme }
